...
public class MainHeroNPCModel<T extends MainHeroNPCEntity> extends SinglePartEntityModel<T> {
    private final ModelPart Character;
    private final ModelPart Head;

    public MainHeroNPCModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData RightArmStart = RightArm.addChild("RightArmStart", ModelPartBuilder.create().uv(40, 16).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F))
                .uv(40, 32).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 5.5F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData RightArmEnd = RightArm.addChild("RightArmEnd", ModelPartBuilder.create().uv(40, 22).cuboid(-2.0F, 0.1633F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F))
                .uv(40, 38).cuboid(-2.0F, 0.1633F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.25F))
                .uv(40, 16).cuboid(-2.0F, 6.2133F, -2.0F, 4.0F, 0.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.0F, 3.8367F, 0.0F));

        ModelPartData LeftArm = BodyPart.addChild("LeftArm", ModelPartBuilder.create(), ModelTransform.pivot(5.0F, -7.0F, 0.0F));

        ModelPartData LeftArmStart = LeftArm.addChild("LeftArmStart", ModelPartBuilder.create().uv(32, 48).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F))
                .uv(48, 48).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 5.5F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData LeftArmEnd = LeftArm.addChild("LeftArmEnd", ModelPartBuilder.create().uv(48, 54).cuboid(-2.0F, 0.1633F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.25F))
                .uv(32, 54).cuboid(-2.0F, 0.1633F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F))
                .uv(32, 48).cuboid(-2.0F, 6.2133F, -2.0F, 4.0F, 0.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(1.0F, 3.8367F, 0.0F));
    ...
    @Override
    public void setAngles(MainHeroNPCEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {

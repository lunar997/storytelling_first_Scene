...
public class WideNPCModel<T extends WideNPCEntity> extends SinglePartEntityModel<T> {
	private final ModelPart Character;
	private final ModelPart Head;

	public WideNPCModel(ModelPart root) {
	...
	@Override
	public void setAngles(WideNPCEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {

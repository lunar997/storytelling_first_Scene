package net.lunar.StoryEntities.SlimNPCWithBoobs;
...
public class SlimNPCModel<T extends SlimBoobsNPCEntity> extends SinglePartEntityModel<T> {
	private final ModelPart Character;
	private final ModelPart Head;

	public SlimNPCModel(ModelPart root) {
	...
	@Override
	public void setAngles(SlimBoobsNPCEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
